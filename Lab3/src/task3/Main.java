...
public class Main {
    public static void main(final String[] args) {
        ...
        final Student s1 = new Student("Taras", "Shevcenko", "Grivorovich", subjects);
        final Student s2 = new Student("Taras", "Petrenko", "Ivanovich", subjects);
        final Student s3 = new Student("Stepan", "Srepanov", "Bohdanovich", subjects);
        final Student s4 = new Student("David", "Villa", "Damidovich", subjects);
